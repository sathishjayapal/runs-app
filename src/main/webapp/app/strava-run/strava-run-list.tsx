      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th scope="col" className="text-left p-2">{t('stravaRun.createdAt.label')}</th>
            <th scope="col" className="text-left p-2">{t('stravaRun.updatedAt.label')}</th>
            <th></th>
          </tr>
        </thead>
        <tbody className="border-t-2 border-black">
          ...
          <tr key={stravaRun.runNumber} className="odd:bg-gray-100">
            ...
            <td className="p-2">{stravaRun.createdAt}</td>
            <td className="p-2">{stravaRun.updatedAt}</td>
            <td className="p-2">
