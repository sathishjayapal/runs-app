...
declare module 'yup' {
  interface StringSchema<TType extends yup.Maybe<string> = string | undefined, TContext = yup.AnyObject, TDefault = undefined, TFlags extends yup.Flags = ''>
    ...
    numeric(
      precision: number | yup.Reference<number>,
      scale: number | yup.Reference<number>,
      msg?: yup.Message<{ precision: number; scale: number }>,
    ): this;
    offsetDateTime(msg?: yup.Message): this;
  }
  interface NumberSchema<TType extends yup.Maybe<number> = number | undefined, TContext = yup.AnyObject, TDefault = undefined, TFlags extends yup.Flags = ''>
    extends yup.Schema<TType, TContext, TDefault, TFlags> {
